...
const Chart = (props) => {
  const [ox, setOx] = useState("Место нахождения");
  ...
  const createArrGraph = (data, key) => {
    ...
    data.forEach(item => {
      ...
      groups[k].push(item["Посещаемость в год"]);
    });
    ...
    return entries.map(([label, heights]) => ({
      labelX: key === "Год открытия" ? Number(label) : label,
        ...
        <div>
          <label>
            <input
              ...
              defaultChecked={ox === "Место нахождения"}
            />
            {" "}Место нахождения
          </label>
          ...
          <label>
            <input
              ...
              name="ox"
              value="Год открытия"
              defaultChecked={ox === "Год открытия"}
            />
            {" "}Год открытия
          </label>
        </div>
