...
export type tSeries = {
  'Максимальная посещаемость': boolean;
  'Средняя посещаемость': boolean;
  'Минимальная посещаемость': boolean;
};
    ...
    >
      ...
      <FormControl>
        ...
        <FormControlLabel
          control={
            <Checkbox
              checked={series['Максимальная посещаемость']}
              onChange={handleChange}
              name="Максимальная посещаемость"
            />
          }
          label="максимальную посещаемость"
        />
        <FormControlLabel
          control={
            <Checkbox
              checked={series['Средняя посещаемость']}
              onChange={handleChange}
              name="Средняя посещаемость"
            />
          }
          label="среднюю посещаемость"
        />
        <FormControlLabel
          control={
            <Checkbox
              checked={series['Минимальная посещаемость']}
              onChange={handleChange}
              name="Минимальная посещаемость"
            />
          }
          label="минимальную посещаемость"
        />
      </FormControl>
    </Stack>
  );
